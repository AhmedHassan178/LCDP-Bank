...
public class CLOSED extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ANOTHERACCOUNT = new javax.swing.JButton();
        ...
        ANOTHERACCOUNT.setBackground(new java.awt.Color(85, 5, 14));
        ANOTHERACCOUNT.setFont(new java.awt.Font("Compacta BT", 0, 24)); // NOI18N
        ANOTHERACCOUNT.setForeground(new java.awt.Color(255, 255, 255));
        ANOTHERACCOUNT.setText("Another Account");
        ANOTHERACCOUNT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ANOTHERACCOUNTActionPerformed(evt);
            }
        });
        jPanel1.add(ANOTHERACCOUNT);
        ANOTHERACCOUNT.setBounds(310, 370, 170, 40);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lcdp/bank/CLOSED.jpg"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    private javax.swing.JButton ANOTHERACCOUNT;
